<html>
  ...
  <body>
    ...
    <!-- Modal -->
    <div class="modal fade" id="modalRegistraDespesa" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div id="titulo-modal">
            <h5 item class="modal-title"> </h5>
          ...
          <div class="modal-footer">
            <button id="botao-modal" type="button" class="btn btn-primary" data-dismiss="modal"> </button>
          </div>
        </div>
      </div>
    </div>
